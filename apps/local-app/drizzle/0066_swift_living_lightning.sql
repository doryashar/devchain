...
CREATE INDEX `connector_field_mappings_connector_id_idx` ON `connector_field_mappings` (`connector_id`);--> statement-breakpoint
...
--> statement-breakpoint
CREATE INDEX `connector_status_mappings_connector_id_idx` ON `connector_status_mappings` (`connector_id`);--> statement-breakpoint
...
--> statement-breakpoint
CREATE UNIQUE INDEX `connector_sync_state_connector_epic_idx` ON `connector_sync_state` (`connector_id`,`epic_id`);--> statement-breakpoint
CREATE INDEX `connector_sync_state_connector_external_idx` ON `connector_sync_state` (`connector_id`,`external_id`);--> statement-breakpoint
...
--> statement-breakpoint
CREATE INDEX `connectors_project_id_idx` ON `connectors` (`project_id`);--> statement-breakpoint
